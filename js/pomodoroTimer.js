            ...
            <div class="pomodoro-page">
                        ...
                        <div class="timer-circle">
                            <svg class="progress-ring" width="300" height="300">
                                <circle class="progress-ring-bg" stroke="var(--bg-secondary)" 
                                        stroke-width="12" fill="transparent" r="130" cx="150" cy="150"/>
                                <circle class="progress-ring-fill" stroke="var(--accent-primary)" 
                                        stroke-width="12" fill="transparent" r="130" cx="150" cy="150"
                ...
                `<button class="timer-btn warning" onclick="PomodoroTimer.pause()">
                    ...
                    <div class="session-stats">
                        ...
                        <div class="stat-item">
                            <span class="stat-value">${this.totalSessionsToday * this.settings.workDuration}</span>
